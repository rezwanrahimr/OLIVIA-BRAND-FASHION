...
const Cart = () => {
  ...
  useEffect(() => {
    fetch(`https://olivia-brand-fashion-backend.vercel.app/products/${id}`, {
      method: "GET",
      headers: {
  ...
  // Payment
  const handleByeNow = () => {
    fetch("https://olivia-brand-fashion-backend.vercel.app/payment", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="mt-5">
      <h1 className="text-center text-black fw-bold text-uppercase">
        Your cart
      </h1>
      <div className="d-flex justify-content-center align-items-center">
        {productData?.map((product) => (
          <MDBCard key={product?._id} style={{ maxWidth: "740px" }}>
                ...
                <MDBCardBody>
                  ...
                  <MDBCardText>
                    <p className="productDec">
                      The Beauty is in the name.Wear this rakish grey plaid
                      jacket and all will know that you are the Boss.Named after
                      the 3 time Melboume Cup winning champion Jacket of Makybe
                      Diva,Glen,Boss,Featuring a notch lapel and made from
                      perminum super 130%s 100% wool.
                    </p>
                    -Length:109cm <br />
                    -Regular fit <br />
                    -Wrap-style front <br />
                  ...
                  <MDBCardText>
                    <div className="checkOutBtn">
                      <Link to="/Dashboard">
                        <button onClick={handleByeNow} className="text-white">
                          CHECK OUT
                        </button>
                      </Link>
                    </div>
